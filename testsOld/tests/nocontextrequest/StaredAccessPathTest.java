...
public class StaredAccessPathTest	extends AliasTest{
	@Ignore
	@Test
	public void test1() {
		runAnalysis(false, new IQueryHandler() {
			...
			public ArrayList<MethodQueries> queryAndResults() {
				...
				res.add(inMethod("<cases.StaredAccessPathTarget: void test1()>").
							askForLocalAtStmt(20, "q", 
									andExpect(3,"e")));
	...
	public String getTargetClass() {
		...
		return "cases.StaredAccessPathTarget";
	}
}
