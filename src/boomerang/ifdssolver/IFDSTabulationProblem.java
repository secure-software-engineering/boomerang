 ...
 * 
 * Contributors: Eric Bodden - initial API and implementation Johannes Spaeth - Updates necessary
 * for AliasFinder
 ******************************************************************************/
 ...
 */
public interface IFDSTabulationProblem<N, D, M, I extends BiDiInterproceduralCFG<N, M>> extends
    SolverConfiguration {
