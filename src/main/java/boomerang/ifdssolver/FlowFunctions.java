...
public interface FlowFunctions<N, D, M> {
	 ...
	 */
	public FlowFunction<D> getNormalFlowFunction(IPathEdge<N,D> edge, N succ);
	 ...
	 */
	public FlowFunction<D> getCallFlowFunction(IPathEdge<N,D> edge,  M destinationMethod, N firstStmtInCallee);
	 ...
	 * @return
	 */
	public FlowFunction<D> getReturnFlowFunction(IPathEdge<N,D> edge, N callStmt,  M calleeMethod, N returnSite);
