...
public class Example {
 ...
 new Query("<example.Program3: void context(java.lang.Object,java.lang.Object)>",
    ...
    // Example 4
    // Client-driven context-resolution
    initializeSoot("example.Program4");
    icfg = new InfoflowCFG();
    af = new AliasFinder(icfg);
    query = new Query("<example.Program4: void context(java.lang.Object,java.lang.Object)>",
        "queryVariable", 4);
    af.startQuery();
    aliases = af.findAliasAtStmt(query.getAccessGraph(), query.getStatement(), new ClientDrivenContextResolution(icfg));
    System.out.println(query);
    System.out.println(aliases.withMethodOfAllocationSite(icfg));
